"""
Visualize ORPC TidGen 2.0 portfolio optimization results.
...
Input:  results/orpc/<group>/optimization_results.nc
        results/orpc/<group>/covariance.nc
        inputs/geography/NOAA_MedRes/allus80k.shp
Output: results/orpc/<group>/figures/
"""
